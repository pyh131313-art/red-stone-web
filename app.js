...
const boardItems = [
  {
    ...
    title: "新一波周邊預購準備中",
    date: "04.18",
    description: "正在整理上架頁與商品拍攝，預計下週公開完整資訊。",
  },
  {
    type: "最近完成",
    title: "完成一組角色主視覺與短動畫封面",
    date: "04.15",
    description: "已交付給合作方，之後會整理成作品集版本放進圖庫。",
  },
  {
    type: "工作近況",
    title: "調整網站內容，準備把社群與商店整合",
    date: "04.12",
    description: "希望讓第一次來的人也能快速理解我最近在做什麼。",
  },
  {
    type: "提醒",
    title: "委託檔期更新",
    date: "04.10",
    description: "五月的個人委託名額即將滿額，想排單的人可以先私訊詢問。",
  },
];
